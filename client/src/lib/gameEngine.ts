...
export const LEVELS: LevelConfig[] = [
  ...
  // L1 — Tier 1: merge-2, grab≤2, 3 towers, goal: ginger + white
  {
    id: 1, name: 'Sunny Windowsill', world: 1, levelInWorld: 1, isBoss: false,
    description: 'Match 2 orange cats and 2 white cats!',
  ...
  // L5 — Tier 2 boss: merge-3, grab≤3, 5 towers, goal: ginger+white
  {
    ...
    containers: [
      { id: 'c1', grabNumber: 2, capacity: 10, position: { x: 0, y: 0 }, startStack: ['white', 'ginger', 'tabby', 'ginger', 'white', 'black'] },
      ...
      { id: 'c4', grabNumber: 2, capacity: 10, position: { x: 3, y: 0 }, startStack: ['white', 'ginger', 'tabby', 'black'] },
      { id: 'c5', grabNumber: 3, capacity: 10, position: { x: 4, y: 0 }, startStack: [] },
    ],
  },
  ...
  // L6 — Tier 3: merge-3, grab≤3, 4 towers, goal: black+tabby
  {
    ...
    containers: [
      { id: 'c1', grabNumber: 2, capacity: 10, position: { x: 0, y: 0 }, startStack: ['white', 'black', 'tabby', 'calico', 'black'] },
      { id: 'c2', grabNumber: 3, capacity: 10, position: { x: 1, y: 0 }, startStack: ['tabby', 'ginger', 'black', 'tabby', 'ginger'] },
      { id: 'c3', grabNumber: 2, capacity: 10, position: { x: 2, y: 0 }, startStack: ['black', 'calico', 'tabby', 'white', 'tabby'] },
      { id: 'c4', grabNumber: 3, capacity: 10, position: { x: 3, y: 0 }, startStack: [] },
    ],
  },
  ...
  // L7 — Tier 3: merge-3, grab≤3, 5 towers, goal: calico+siamese
  {
    ...
    containers: [
      ...
      { id: 'c2', grabNumber: 2, capacity: 10, position: { x: 1, y: 0 }, startStack: ['siamese', 'tabby', 'calico', 'black', 'siamese'] },
      { id: 'c3', grabNumber: 3, capacity: 10, position: { x: 2, y: 0 }, startStack: ['calico', 'ginger', 'siamese', 'tabby', 'calico'] },
      { id: 'c4', grabNumber: 2, capacity: 10, position: { x: 3, y: 0 }, startStack: ['black', 'siamese', 'ginger'] },
      { id: 'c5', grabNumber: 3, capacity: 10, position: { x: 4, y: 0 }, startStack: [] },
    ],
  },
  ...
  // L8 — Tier 3→4 bridge: merge-3, grab≤3, 5 towers, goal: ginger+black, tighter
  {
    ...
    containers: [
      { id: 'c1', grabNumber: 2, capacity: 10, position: { x: 0, y: 0 }, startStack: ['tabby', 'ginger', 'white', 'black', 'ginger'] },
      { id: 'c2', grabNumber: 3, capacity: 10, position: { x: 1, y: 0 }, startStack: ['black', 'calico', 'ginger', 'tabby', 'black'] },
      { id: 'c3', grabNumber: 2, capacity: 10, position: { x: 2, y: 0 }, startStack: ['ginger', 'siamese', 'black', 'white', 'ginger'] },
  ...
  // L9 — Tier 4: merge-3, grab≤3, 5 towers, goal: white+siamese, frozen tower
  {
    ...
    containers: [
      ...
      { id: 'c3', grabNumber: 2, capacity: 10, position: { x: 2, y: 0 }, startStack: ['ginger', 'white', 'tabby', 'siamese', 'black'] },
  ...
  // L10 — Tier 4 boss: merge-3, grab≤3, 6 towers, goal: tabby+calico+ginger
  {
    ...
    containers: [
      { id: 'c1', grabNumber: 2, capacity: 10, position: { x: 0, y: 0 }, startStack: ['ginger', 'tabby', 'calico', 'black', 'ginger', 'tabby'] },
      ...
      { id: 'c4', grabNumber: 2, capacity: 10, position: { x: 3, y: 0 }, startStack: ['ginger', 'calico', 'tabby', 'siamese', 'ginger'] },
  ...
  // L11 — Tier 5: merge-3, grab≤2, 5 towers, goal: black+siamese
  {
    ...
    containers: [
      { id: 'c1', grabNumber: 1, capacity: 10, position: { x: 0, y: 0 }, startStack: ['white', 'black', 'siamese', 'tabby', 'black', 'siamese'] },
      ...
      { id: 'c4', grabNumber: 1, capacity: 10, position: { x: 3, y: 0 }, startStack: ['ginger', 'siamese', 'calico'] },
  ...
  // L12 — Tier 5: merge-3, grab≤2, 5 towers, goal: white+ginger, coat-locked
  {
    ...
    containers: [
      ...
      { id: 'c3', grabNumber: 1, capacity: 10, position: { x: 2, y: 0 }, startStack: ['white', 'black', 'ginger', 'tabby', 'white'], coatLocked: 'white' },
  ...
  // L13 — Tier 5→6 bridge: merge-3, grab≤2, 6 towers, goal: calico+tabby, tight
  {
    ...
    containers: [
      { id: 'c1', grabNumber: 1, capacity: 10, position: { x: 0, y: 0 }, startStack: ['siamese', 'calico', 'tabby', 'black', 'calico', 'tabby'] },
      ...
      { id: 'c4', grabNumber: 1, capacity: 10, position: { x: 3, y: 0 }, startStack: ['tabby', 'ginger', 'calico', 'white'] },
  ...
  // L14 — Tier 6: merge-3, grab≤2, 6 towers, goal: ginger+white+black
  {
    ...
    containers: [
      ...
      { id: 'c2', grabNumber: 1, capacity: 10, position: { x: 1, y: 0 }, startStack: ['black', 'siamese', 'ginger', 'white', 'black'] },
      ...
      { id: 'c5', grabNumber: 1, capacity: 10, position: { x: 4, y: 0 }, startStack: ['black', 'tabby', 'ginger'] },
      { id: 'c6', grabNumber: 2, capacity: 10, position: { x: 5, y: 0 }, startStack: [] },
    ],
  },
  ...
  // L15 — Tier 6 boss: merge-3, grab≤2, 6 towers, goal: siamese+calico+tabby
  {
    ...
    triggers: [{ event: 'onVanishComplete', condition: { vanishesCompleted: 3 }, action: { type: 'grantBudget', moves: 4 } }],
    containers: [
      { id: 'c1', grabNumber: 1, capacity: 10, position: { x: 0, y: 0 }, startStack: ['siamese', 'calico', 'tabby', 'black', 'siamese', 'calico'] },
      { id: 'c2', grabNumber: 2, capacity: 10, position: { x: 1, y: 0 }, startStack: ['tabby', 'white', 'siamese', 'calico', 'tabby', 'ginger'] },
      { id: 'c3', grabNumber: 2, capacity: 10, position: { x: 2, y: 0 }, startStack: ['calico', 'black', 'tabby', 'siamese', 'calico'] },
      { id: 'c4', grabNumber: 1, capacity: 10, position: { x: 3, y: 0 }, startStack: ['siamese', 'ginger', 'calico', 'tabby', 'siamese'] },
  ...
  // L16 — Tier 7: merge-3, grab≤2, 6 towers, goal: ginger+siamese+black
  {
    ...
    containers: [
      ...
      { id: 'c2', grabNumber: 1, capacity: 10, position: { x: 1, y: 0 }, startStack: ['black', 'tabby', 'ginger', 'siamese', 'black'] },
      { id: 'c3', grabNumber: 2, capacity: 10, position: { x: 2, y: 0 }, startStack: ['siamese', 'calico', 'black', 'ginger', 'siamese'] },
      { id: 'c4', grabNumber: 1, capacity: 10, position: { x: 3, y: 0 }, startStack: ['ginger', 'black', 'tabby', 'siamese', 'ginger'] },
  ...
  // L17 — Tier 7: merge-3, grab≤2, 6 towers, goal: white+tabby+calico
  {
    ...
    starThresholds: { two: 0.15, three: 0.32 }, triggers: [],
    containers: [
      { id: 'c1', grabNumber: 1, capacity: 10, position: { x: 0, y: 0 }, startStack: ['ginger', 'white', 'tabby', 'calico', 'white', 'black'] },
      ...
      { id: 'c4', grabNumber: 1, capacity: 10, position: { x: 3, y: 0 }, startStack: ['white', 'ginger', 'tabby', 'siamese', 'white'] },
  ...
  // L18 — Tier 7: merge-3, grab≤2, 6 towers, goal: all 6 coats, brutal
  {
    ...
    containers: [
      { id: 'c1', grabNumber: 1, capacity: 10, position: { x: 0, y: 0 }, startStack: ['ginger', 'white', 'black', 'tabby', 'calico', 'siamese'] },
      { id: 'c2', grabNumber: 1, capacity: 10, position: { x: 1, y: 0 }, startStack: ['siamese', 'ginger', 'calico', 'black', 'white'] },
      { id: 'c3', grabNumber: 2, capacity: 10, position: { x: 2, y: 0 }, startStack: ['tabby', 'calico', 'ginger', 'siamese', 'black'] },
      { id: 'c4', grabNumber: 1, capacity: 10, position: { x: 3, y: 0 }, startStack: ['white', 'tabby', 'siamese', 'ginger', 'calico'] },
  ...
  // L19 — Tier 7 penultimate: merge-3, grab≤2, 6 towers, goal: 4 coats
  {
    ...
    starThresholds: { two: 0.12, three: 0.28 }, triggers: [],
    containers: [
      { id: 'c1', grabNumber: 1, capacity: 10, position: { x: 0, y: 0 }, startStack: ['white', 'ginger', 'black', 'calico', 'siamese', 'tabby'] },
      { id: 'c2', grabNumber: 2, capacity: 10, position: { x: 1, y: 0 }, startStack: ['siamese', 'calico', 'ginger', 'black', 'siamese'] },
      { id: 'c3', grabNumber: 1, capacity: 10, position: { x: 2, y: 0 }, startStack: ['black', 'tabby', 'siamese', 'ginger', 'calico'] },
  ...
  // L20 — FINAL BOSS: merge-3, grab≤2, 6 towers, goal: all 6 coats
  {
    ...
    containers: [
      ...
      { id: 'c3', grabNumber: 1, capacity: 10, position: { x: 2, y: 0 }, startStack: ['tabby', 'calico', 'ginger', 'siamese', 'black', 'white'] },
      { id: 'c4', grabNumber: 2, capacity: 10, position: { x: 3, y: 0 }, startStack: ['white', 'black', 'siamese', 'ginger', 'calico', 'tabby'] },
      { id: 'c5', grabNumber: 1, capacity: 10, position: { x: 4, y: 0 }, startStack: ['black', 'tabby', 'white', 'calico', 'siamese'] },
      { id: 'c6', grabNumber: 2, capacity: 10, position: { x: 5, y: 0 }, startStack: [] },
    ],
  },
];
